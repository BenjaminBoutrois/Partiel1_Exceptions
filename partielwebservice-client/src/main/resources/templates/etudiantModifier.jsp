...
<div class="container">
	...
	<a class="btn btn-primary mb-5  text-center " href="etudiant.jsp">Liste des &eacute;tudiants</a>
	...
	<div class="">
		...
		<div class="pt-4 pb-3">
			...
			<form action="ModifEtudiantServlet" method="post">
				...
				<div class="md-form md-outline mt-0">
					<label for="numberPhone">Num&eacute;ro t&eacute;l&eacute;phone</label>
